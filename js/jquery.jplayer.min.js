...
(function(c, h) {
    ...
    c.jPlayer.convertTime = function(a) {
        ...
        return (c.jPlayer.timeFormat.showHour ?
            b + c.jPlayer.timeFormat.sepHour : "") + (c.jPlayer.timeFormat.showMin ? d + c.jPlayer.timeFormat.sepMin : "") + (c.jPlayer.timeFormat.showSec ? a + c.jPlayer.timeFormat.sepSec : "")
    };
    ...
    c.jPlayer.prototype = {
        ...
        _init: function() {
            ...
            c.each(this.formats, function(e, g) {
                a.html.canPlay[g] =
                    a.html[a.format[g].media].available && "" !== a.htmlElement[a.format[g].media].canPlayType(a.format[g].codec);
            ...
            if (this.flash.used) {
                ...
                if (c.browser.msie && Number(c.browser.version) <= 8) {
                    ...
                    d += ' codebase="' + document.URL.substring(0, document.URL.indexOf(":")) +
                ...
                c.each(b.solutions, function(n, k) {
                    if (b[k].support[i] && b._validString(a[i])) {
                        ...
                        if (b.flash.active || b.html.active && b.flash.gate || d === b.html.audio.gate && f === b.html.video.gate) b.clearMedia();
                            ...
                            b.html.audio.gate && f !== b.html.video.gate) {
                            b._html_pause();
                        ...
                        if (j) {
                            ...
                            b.css.jq.videoPlay.length &&
                                b.css.jq.videoPlay.hide();
        ...
        _checkForFlash: function(a) {
            ...
            return c.browser.msie &&
                Number(c.browser.version) >= 9 ? false : b
        },
        ...
        _error: function(a) {
            this._trigger(c.jPlayer.event.error,
                a);
